      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Temukan sepeda keinginan Anda!</h1>
            <p>Kami memiliki lebih dari seribu sepeda untuk Anda pilih.</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Temukan yang Terbaik <br>
      <span>sepeda untuk Anda</span></h2>
      <p>Anda akan dapat menikmati liburan dan perjalanan Anda sepenuhnya! Masalah apapun? Tim kami yang penuh semangat akan dengan senang hati membantu Anda!! Jangan buang waktu selama liburan Anda untuk mencari tempat persewaan di tempat! Tidak ada kendala bahasa, berkat tim multibahasa kami! Dengan harga yang sama dengan yang Anda bayarkan di tempat! Kami memiliki sepeda terbaik dengan penawaran terbaik.</p>
    </div>
    <div class="row">
...
<span class="price">Rp <?php echo htmlentities($result->PricePerDay);?> Ribu</span>
</div>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-motorcycle " aria-hidden="true"></i>255+</h2>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Anda Puas Dengan Pelayanan Kami?<br>
      <span>Tulis Ulasan Anda!</span></h2>
    </div>
    <div class="row">
